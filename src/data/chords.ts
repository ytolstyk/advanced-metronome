...
export const GUITAR_TUNINGS: GuitarTuning[] = [
  ...
  {
    id: "d-standard-6",
    label: "D Standard (DGCFAD)",
    stringCount: 6,
    openMidi: [38, 43, 48, 53, 57, 62],
  ...
  {
    id: "b-standard-7",
    label: "B Standard (BEADGBe)",
    stringCount: 7,
    openMidi: [35, 40, 45, 50, 55, 59, 64],
    stringNames: ["B", "E", "A", "D", "G", "B", "e"],
  },
  {
    id: "drop-a-7",
    label: "Drop A (AEADGBe)",
    stringCount: 7,
    openMidi: [33, 40, 45, 50, 55, 59, 64],
    stringNames: ["A", "E", "A", "D", "G", "B", "e"],
  },
  {
    id: "bb-standard-7",
    label: "Bb Standard",
    stringCount: 7,
    openMidi: [34, 39, 44, 49, 54, 58, 63],
    stringNames: ["Bb", "Eb", "Ab", "Db", "Gb", "Bb", "eb"],
  },
  // 8-string
  {
    id: "f#-standard-8",
    label: "F# Standard (F#BEADGBe)",
    stringCount: 8,
    openMidi: [30, 35, 40, 45, 50, 55, 59, 64],
    stringNames: ["F#", "B", "E", "A", "D", "G", "B", "e"],
  },
  {
    id: "drop-e-8",
    label: "Drop E (EBEADGBe)",
    stringCount: 8,
    openMidi: [28, 35, 40, 45, 50, 55, 59, 64],
    stringNames: ["E", "B", "E", "A", "D", "G", "B", "e"],
  },
  {
    id: "f-standard-8",
    label: "F Standard",
    stringCount: 8,
    openMidi: [29, 34, 39, 44, 49, 54, 58, 63],
    stringNames: ["F", "Bb", "Eb", "Ab", "Db", "Gb", "Bb", "eb"],
  },
];
...
function addExtraStrings(
  ...
  const newVoicings = entry.voicings.map((voicing) => {
    ...
    const barre = voicing.barre
      ? {
          ...voicing.barre,
          fromString: voicing.barre.fromString + extraCount,
          toString: voicing.barre.toString + extraCount,
        }
      : undefined;
...
function transpose6StringVoicing(
...
export function getChordDatabase(tuning: GuitarTuning): ChordEntry[] {
  ...
  if (tuning.stringCount === 6) {
    const transposed = CHORD_DATABASE.map((entry) => ({
      ...entry,
      voicings: entry.voicings.map((v) =>
        transpose6StringVoicing(v, tuning.openMidi),
      ),
    }));
    ...
    return transposed.map((entry) => {
      const specificEntry = specific.find(
        (s) => s.root === entry.root && s.type === entry.type,
      );
      if (!specificEntry) return entry;
      return {
        ...entry,
        voicings: [...specificEntry.voicings, ...entry.voicings],
      };
    });
  }
...
export const CHORD_DATABASE: ChordEntry[] = [
  ...
  },
  {
    root: "C",
    type: "sus2",
    voicings: [{ frets: [-1, 3, 5, 5, 3, 3], startFret: 3 }],
  },
  ...
  { root: "C", type: "dim7", voicings: [{ frets: [-1, -1, 1, 2, 1, 2] }] },
  {
    root: "C",
    type: "m7b5",
    voicings: [{ frets: [-1, 3, 4, 3, 4, 3], startFret: 3 }],
  },
  ...
  { root: "C", type: "maj7", voicings: [{ frets: [-1, 3, 2, 0, 0, 0] }] },
  {
    root: "C",
    type: "m7",
    voicings: [{ frets: [-1, 3, 5, 3, 4, 3], startFret: 3 }],
  },
  ...
  { root: "C", type: "6", voicings: [{ frets: [-1, 3, 2, 2, 1, 0] }] },
  {
    root: "C",
    type: "m6",
    voicings: [{ frets: [-1, 3, 1, 2, 4, -1] }],
  },
  {
    root: "C",
    type: "9",
    voicings: [{ frets: [-1, 3, 2, 3, 3, 3], startFret: 3 }],
  },
  { root: "C", type: "maj9", voicings: [{ frets: [-1, 3, 2, 0, 3, 0] }] },
  {
    root: "C",
    type: "5",
    voicings: [{ frets: [-1, 3, 5, -1, -1, -1], startFret: 3 }],
  },
  ...
  },
  {
    root: "C#",
    type: "sus2",
    voicings: [{ frets: [-1, 4, 6, 6, 4, 4], startFret: 4 }],
  },
  {
    root: "C#",
    type: "sus4",
    voicings: [{ frets: [-1, 4, 6, 6, 7, 4], startFret: 4 }],
  },
  ...
  { root: "C#", type: "dim7", voicings: [{ frets: [-1, -1, 2, 3, 2, 3] }] },
  {
    root: "C#",
    type: "m7b5",
    voicings: [{ frets: [-1, 4, 5, 4, 5, 4], startFret: 4 }],
  },
  {
    root: "C#",
    type: "add9",
    voicings: [{ frets: [-1, 4, 6, 6, 6, 6], startFret: 4 }],
  },
  {
    root: "C#",
    type: "add4",
    voicings: [{ frets: [-1, 4, 6, 6, 6, 7], startFret: 4 }],
  },
  {
    root: "C#",
    type: "add7",
    voicings: [{ frets: [-1, 4, 6, 6, 6, 4], startFret: 4 }],
  },
  {
    root: "C#",
    type: "maj7",
    voicings: [{ frets: [-1, 4, 3, 1, 1, 1], startFret: 1 }],
  },
  {
    root: "C#",
    type: "m7",
    voicings: [{ frets: [-1, 4, 6, 4, 5, 4], startFret: 4 }],
  },
  ...
  },
  {
    root: "C#",
    type: "9",
    voicings: [{ frets: [-1, 4, 3, 4, 4, 4], startFret: 1 }],
  },
  {
    root: "C#",
    type: "maj9",
    voicings: [{ frets: [-1, 4, 3, 1, 4, 1], startFret: 1 }],
  },
  {
    root: "C#",
    type: "5",
    voicings: [{ frets: [-1, 4, 6, -1, -1, -1], startFret: 4 }],
  },
  ...
  { root: "D#", type: "dim7", voicings: [{ frets: [-1, -1, 1, 2, 1, 2] }] },
  {
    root: "D#",
    type: "m7b5",
    voicings: [{ frets: [-1, 6, 7, 6, 7, 6], startFret: 6 }],
  },
  ...
  { root: "D#", type: "m6", voicings: [{ frets: [-1, -1, 1, 3, 1, 2] }] },
  {
    root: "D#",
    type: "9",
    voicings: [{ frets: [-1, 6, 5, 6, 6, 6], startFret: 5 }],
  },
  ...
  { root: "F", type: "dim7", voicings: [{ frets: [-1, -1, 0, 1, 0, 1] }] },
  {
    root: "F",
    type: "m7b5",
    voicings: [{ frets: [1, 2, 3, 1, 1, 1], startFret: 1 }],
  },
  ...
  },
  {
    root: "F",
    type: "add7",
    voicings: [{ frets: [1, 3, 3, 2, 4, 1], startFret: 1 }],
  },
  { root: "F", type: "maj7", voicings: [{ frets: [-1, -1, 3, 2, 1, 0] }] },
  {
    root: "F",
    type: "m7",
    voicings: [{ frets: [1, 3, 3, 1, 4, 1], startFret: 1 }],
  },
  {
    root: "F",
    type: "7",
  ...
  { root: "F", type: "m6", voicings: [{ frets: [-1, -1, 0, 1, 1, 1] }] },
  {
    root: "F",
    type: "9",
    voicings: [{ frets: [1, 3, 1, 2, 1, 3], startFret: 1 }],
  },
  ...
  },
  {
    root: "F#",
    type: "sus2",
    voicings: [{ frets: [2, 4, 4, 1, 2, 2], startFret: 2 }],
  },
  {
    root: "F#",
    type: "sus4",
    voicings: [{ frets: [2, 4, 4, 4, 2, 2], startFret: 2 }],
  },
  ...
  { root: "F#", type: "dim7", voicings: [{ frets: [-1, -1, 1, 2, 1, 2] }] },
  {
    root: "F#",
    type: "m7b5",
    voicings: [{ frets: [2, 3, 4, 2, 2, 2], startFret: 2 }],
  },
  {
    root: "F#",
    type: "add9",
    voicings: [{ frets: [2, 4, 4, 3, 2, 4], startFret: 2 }],
  },
  {
    root: "F#",
    type: "add4",
  ...
  },
  {
    root: "F#",
    type: "add7",
    voicings: [{ frets: [2, 4, 4, 3, 5, 2], startFret: 2 }],
  },
  {
    root: "F#",
    type: "maj7",
    voicings: [{ frets: [2, 4, 3, 3, 2, 2], startFret: 2 }],
  },
  {
    root: "F#",
    type: "m7",
    voicings: [{ frets: [2, 4, 4, 2, 5, 2], startFret: 2 }],
  },
  {
    root: "F#",
    type: "7",
    voicings: [{ frets: [2, 4, 2, 3, 2, 2], startFret: 2 }],
  },
  {
    root: "F#",
    type: "6",
    voicings: [{ frets: [2, 4, 4, 3, 4, 2], startFret: 2 }],
  },
  {
    root: "F#",
    type: "m6",
    voicings: [{ frets: [2, 4, 4, 2, 4, 2], startFret: 2 }],
  },
  {
    root: "F#",
    type: "9",
    voicings: [{ frets: [2, 4, 2, 3, 2, 4], startFret: 2 }],
  },
  {
    root: "F#",
    type: "maj9",
    voicings: [{ frets: [2, 4, 3, 3, 2, 4], startFret: 2 }],
  },
  {
    root: "F#",
    type: "5",
    voicings: [{ frets: [2, 4, -1, -1, -1, -1], startFret: 2 }],
  },
  ...
  { root: "G", type: "sus2", voicings: [{ frets: [3, 0, 0, 0, 3, 3] }] },
  {
    root: "G",
    type: "sus4",
    voicings: [{ frets: [3, 5, 5, 5, 3, 3], startFret: 3 }],
  },
  ...
  { root: "G", type: "dim7", voicings: [{ frets: [3, -1, 2, 3, 2, -1] }] },
  {
    root: "G",
    type: "m7b5",
    voicings: [{ frets: [3, 4, 5, 3, 3, 3], startFret: 3 }],
  },
  ...
  { root: "G", type: "maj7", voicings: [{ frets: [3, 2, 0, 0, 0, 2] }] },
  {
    root: "G",
    type: "m7",
    voicings: [{ frets: [3, 5, 5, 3, 6, 3], startFret: 3 }],
  },
  ...
  { root: "G", type: "6", voicings: [{ frets: [3, 2, 0, 0, 0, 0] }] },
  {
    root: "G",
    type: "m6",
    voicings: [{ frets: [3, 5, 5, 3, 5, 3], startFret: 3 }],
  },
  ...
  { root: "G", type: "maj9", voicings: [{ frets: [3, 2, 0, 2, 0, 2] }] },
  {
    root: "G",
    type: "5",
    voicings: [{ frets: [3, 5, -1, -1, -1, -1], startFret: 3 }],
  },
  ...
  },
  {
    root: "G#",
    type: "sus2",
    voicings: [{ frets: [4, 6, 6, 3, 4, 4], startFret: 3 }],
  },
  {
    root: "G#",
    type: "sus4",
    voicings: [{ frets: [4, 6, 6, 6, 4, 4], startFret: 4 }],
  },
  ...
  { root: "G#", type: "dim7", voicings: [{ frets: [-1, -1, 3, 4, 3, 4] }] },
  {
    root: "G#",
    type: "m7b5",
    voicings: [{ frets: [4, 5, 6, 4, 4, 4], startFret: 4 }],
  },
  {
    root: "G#",
    type: "add9",
    voicings: [{ frets: [4, 6, 6, 5, 4, 6], startFret: 4 }],
  },
  {
    root: "G#",
    type: "add4",
  ...
  },
  {
    root: "G#",
    type: "add7",
    voicings: [{ frets: [4, 6, 6, 5, 7, 4], startFret: 4 }],
  },
  {
    root: "G#",
    type: "maj7",
    voicings: [{ frets: [4, 6, 5, 5, 4, 4], startFret: 4 }],
  },
  {
    root: "G#",
    type: "m7",
    voicings: [{ frets: [4, 6, 6, 4, 7, 4], startFret: 4 }],
  },
  {
    root: "G#",
    type: "7",
    voicings: [{ frets: [4, 6, 4, 5, 4, 4], startFret: 4 }],
  },
  {
    root: "G#",
    type: "6",
    voicings: [{ frets: [4, 6, 6, 5, 6, 4], startFret: 4 }],
  },
  {
    root: "G#",
    type: "m6",
    voicings: [{ frets: [4, 6, 6, 4, 6, 4], startFret: 4 }],
  },
  {
    root: "G#",
    type: "9",
    voicings: [{ frets: [4, 6, 4, 5, 4, 6], startFret: 4 }],
  },
  {
    root: "G#",
    type: "maj9",
    voicings: [{ frets: [4, 6, 5, 5, 4, 6], startFret: 4 }],
  },
  {
    root: "G#",
    type: "5",
    voicings: [{ frets: [4, 6, -1, -1, -1, -1], startFret: 4 }],
  },
  ...
  },
  {
    root: "A#",
    type: "sus2",
    voicings: [{ frets: [-1, 1, 3, 3, 1, 1], startFret: 1 }],
  },
  {
    root: "A#",
    type: "sus4",
    voicings: [{ frets: [-1, 1, 3, 3, 4, 1], startFret: 1 }],
  },
  ...
  { root: "A#", type: "dim7", voicings: [{ frets: [-1, -1, 0, 1, 0, 1] }] },
  {
    root: "A#",
    type: "m7b5",
    voicings: [{ frets: [-1, 1, 2, 3, 2, 1], startFret: 1 }],
  },
  {
    root: "A#",
    type: "add9",
    voicings: [{ frets: [-1, 1, 3, 3, 3, 3], startFret: 1 }],
  },
  {
    root: "A#",
    type: "add4",
  ...
  },
  {
    root: "A#",
    type: "add7",
    voicings: [{ frets: [-1, 1, 3, 3, 3, 4], startFret: 1 }],
  },
  {
    root: "A#",
    type: "maj7",
    voicings: [{ frets: [-1, 1, 3, 2, 3, 1], startFret: 1 }],
  },
  {
    root: "A#",
    type: "m7",
    voicings: [{ frets: [-1, 1, 3, 1, 2, 1], startFret: 1 }],
  },
  {
    root: "A#",
    type: "7",
    voicings: [{ frets: [-1, 1, 3, 1, 3, 1], startFret: 1 }],
  },
  {
    root: "A#",
    type: "6",
  ...
  },
  {
    root: "A#",
    type: "m6",
    voicings: [{ frets: [-1, 1, 3, 3, 2, 3], startFret: 1 }],
  },
  {
    root: "A#",
    type: "9",
    voicings: [{ frets: [-1, 1, 3, 1, 3, 3], startFret: 1 }],
  },
  {
    root: "A#",
    type: "maj9",
    voicings: [{ frets: [-1, 1, 3, 2, 3, 3], startFret: 1 }],
  },
  ...
  },
  {
    root: "B",
    type: "sus2",
    voicings: [{ frets: [-1, 2, 4, 4, 2, 2], startFret: 2 }],
  },
  {
    root: "B",
    type: "sus4",
    voicings: [{ frets: [-1, 2, 4, 4, 5, 2], startFret: 2 }],
  },
  ...
  { root: "B", type: "dim7", voicings: [{ frets: [-1, -1, 1, 2, 1, 2] }] },
  {
    root: "B",
    type: "m7b5",
    voicings: [{ frets: [-1, 2, 3, 2, 3, 2], startFret: 2 }],
  },
  {
    root: "B",
    type: "add9",
    voicings: [{ frets: [-1, 2, 4, 4, 4, 4], startFret: 2 }],
  },
  {
    root: "B",
    type: "add4",
  ...
  },
  {
    root: "B",
    type: "add7",
    voicings: [{ frets: [-1, 2, 4, 4, 4, 5], startFret: 2 }],
  },
  {
    root: "B",
    type: "maj7",
    voicings: [{ frets: [-1, 2, 4, 3, 4, 2], startFret: 2 }],
  },
  {
    root: "B",
    type: "m7",
    voicings: [{ frets: [-1, 2, 4, 2, 3, 2], startFret: 2 }],
  },
  {
    root: "B",
    type: "7",
    voicings: [{ frets: [-1, 2, 4, 2, 4, 2], startFret: 2 }],
  },
  {
    root: "B",
    type: "6",
  ...
  },
  {
    root: "B",
    type: "m6",
    voicings: [{ frets: [-1, 2, 4, 4, 3, 4], startFret: 2 }],
  },
  {
    root: "B",
    type: "9",
    voicings: [{ frets: [-1, 2, 4, 2, 4, 4], startFret: 2 }],
  },
  {
    root: "B",
    type: "maj9",
    voicings: [{ frets: [-1, 2, 4, 3, 4, 4], startFret: 2 }],
  },
  {
    root: "B",
    type: "5",
